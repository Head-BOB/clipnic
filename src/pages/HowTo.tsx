    ...
    <div className="min-h-screen bg-[#050505] text-[#F5F5F5] selection:bg-brand selection:text-black">
      ...
      <main className="max-w-7xl mx-auto px-6 pt-32 md:pt-48 pb-10 md:pb-20">
        ...
        <div className="relative space-y-12">
          ...
          >
            <DashPreview>
              <div className="bg-[#080808] border border-white/10 rounded-[2.5rem] p-12 md:p-20 flex items-center justify-center overflow-hidden relative group shadow-2xl min-h-[400px]">
